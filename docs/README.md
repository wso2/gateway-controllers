...
| [OpenAI to Anthropic Transformer](./openai-to-anthropic-transformer/v0.9/docs/openai-to-anthropic-transformer.md) | AI, Transformation | Translates OpenAI Chat Completions requests into Anthropic Messages API format and rewrites non-streaming and streaming Anthropic responses back into OpenAI-compatible JSON or Chat Completions Server-Sent Events. |
| [OpenAI to Azure OpenAI Transformer](./openai-to-azure-openai-transformer/v0.9/docs/openai-to-azure-openai-transformer.md) | AI, Transformation | Routes OpenAI Chat Completions requests to an Azure OpenAI upstream by rewriting the request path with the deployment id and api-version query parameter. |
| [OpenAI to Bedrock Transformer](./openai-to-bedrock-transformer/v0.9/docs/openai-to-bedrock-transformer.md) | AI, Transformation | Translates OpenAI Chat Completions requests into AWS Bedrock Converse format and rewrites non-streaming and streaming Bedrock responses back into OpenAI-compatible JSON or Server-Sent Events. |
| [OpenAI to Gemini Transformer](./openai-to-gemini-transformer/v0.9/docs/openai-to-gemini-transformer.md) | AI, Transformation | Translates OpenAI Chat Completions requests into the Google Gemini generateContent API format and rewrites non-streaming and streaming Gemini responses back into OpenAI-compatible JSON or Chat Completions Server-Sent Events. |
| [OpenAI to Mistral Transformer](./openai-to-mistral-transformer/v0.9/docs/openai-to-mistral-transformer.md) | AI, Transformation | Adapts OpenAI Chat Completions requests for Mistral-compatible upstreams by pinning the model, stripping OpenAI fields Mistral rejects, and rewriting the request path. |
